...
public class CAI3
{
...

   {
       ...
       switch (practiceChoice) {
            ...
            case 1:
                ...
                for(int i=1;i<=10;i++)
                {
                numOfAttempts+=addition(difficultyLevel);
            ...
            case 3:
                for(int i=1;i<=10;i++)
                {
                numOfAttempts+=subtraction(difficultyLevel);
                }
                break;
            ...
            case 4:
                for(int i=1;i<=10;i++)
                {
                numOfAttempts+=division(difficultyLevel);
                }
                break;
   ...
   public static void displayCompletionMessage()
   {
   	...
   	static int addition(int difficultyLevel)
   {            
     ...
     static int subtraction(int difficultyLevel)
    {            
      double answer2 = askQuestion();
      int answer=readResponse();
      isAnswerCorrect(answer2,answer);
